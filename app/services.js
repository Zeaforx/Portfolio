...
export default function Services() {
    ...
    return (
        <section className="services-section container-fluid w-100 d-flex align-items-center justify-content-center flex-column">
            <h1 className="services-header">My services</h1>
            <div className="services-container row mb-3 card-deck w-100 h-100 d-flex align-items-center justify-content-center  flex-row gap-5  ">
                <div className="  col-sm service  ">
